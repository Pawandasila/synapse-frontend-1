...
const sidebarMenuGroups = [
  {
    ...
    items: [
      ...
      { icon: Target, label: 'Challenges', href: '/dashboard/challenges', badge: 'New' },
    ]
  },
  {
    title: 'Community',
    items: [
      ...
      { icon: MessageSquare, label: 'Messages', href: '/dashboard/messages', badge: '12' },
...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  return (
    <div className="flex h-screen bg-background">
      {/* Sidebar */}
      <div className={`${sidebarCollapsed ? 'w-16' : 'w-64'} bg-card border-r border-border transition-width dashboard-sidebar flex flex-col`}>
        {/* Sidebar Header */}
                    ...
                    >
                      ...
                      {!sidebarCollapsed && (
                        <>
                          ...
                          {item.badge && (
                            <Badge variant={item.badge === 'New' ? 'destructive' : 'secondary'} className="text-xs px-2 py-0">
                              {item.badge}
                            </Badge>
                          )}
                        </>
